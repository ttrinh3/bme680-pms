...
Resist = 0
Time = 0
fieldnames = ["Node", "PM1", "PM2", "PM3", "Temp", "Humid", "Press", "Resist", "Time"]
...
def subscribe(client: mqtt_client):
    def on_message(client, userdata, msg):
        ...
        with open('document1.csv','a') as csv_file:
            ...
            print(Node, PM1, PM2, PM3, Temp, Humid, Press, Resist, Time)
...
if __name__ == '__main__':
    with open('document1.csv', 'w') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
