...
def Node1(i):
    data = pd.read_csv('document.csv', header= 0, encoding = 'unicode_escape')
...
PMS = plt.figure("Node1: PMS Data")
ax1 = plt.subplot()

Temper = plt.figure("Node1: Temperature")
ax2 = plt.subplot()

Humidity = plt.figure("Node1: Humidity")
ax3 = plt.subplot()

Pressure = plt.figure("Node1: Pressure")
ax4 = plt.subplot()

Resistance = plt.figure("Node1: Gas Resistance")
ax5 = plt.subplot()
